    ...
    <div style="height:3000px">
        <el-row :gutter="10">
            <el-col :xs="24" :sm="8" :md="6" :lg="6" :xl="4">
                <card :title="$t('card.visit')" :count="30" icon="iconfont icon-jurassic_openeyes" color="#73ACFF"/>
            </el-col>
            <el-col :xs="24" :sm="8" :md="6" :lg="6" :xl="4">
                <card :title="$t('card.pr')" :count="30" icon="iconfont icon-jurassic_openeyes" color="#73ACFF"/>
            </el-col>
            <el-col :xs="24" :sm="8" :md="6" :lg="6" :xl="4">
                <card title="点赞数" :count="10" icon="iconfont icon-star" color="#FDD56A"/>
            </el-col>
            <el-col :xs="24" :sm="8" :md="6" :lg="6" :xl="4">
                <card title="下载数" :count="242" icon="iconfont icon-xiazai1" color="#FDB36A"/>
            </el-col>
            <el-col :xs="24" :sm="8" :md="6" :lg="6" :xl="4">
                <card title="提问数" :count="8" icon="iconfont icon-wenti" color="#FD866A"/>
            </el-col>
            <el-col :xs="24" :sm="8" :md="6" :lg="6" :xl="4">
                <card title="警告数" :count="0" icon="iconfont icon-jinggao1" color="#9E87FF"/>
            </el-col>
        </el-row>
        <el-row :gutter="10">
