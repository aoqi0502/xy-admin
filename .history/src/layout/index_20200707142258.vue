                            ...
                            <div class="grid-content bg-purple-light">
                                ...
                                <el-dropdown style="vertical-align: middle" @command="handLeUser">
                                  <div class="el-dropdown-link" style="cursor: pointer;height: 60px;display: flex;align-items: center">
                                    ...
                                    <el-dropdown-menu slot="dropdown">
                                        <el-dropdown-item command="user" :disabled="language == ''">{{$t('avatar.profile')}}</el-dropdown-item>
                                        <el-dropdown-item command="layout" :disabled="">{{$t('avatar.logout')}}</el-dropdown-item>
                                    </el-dropdown-menu>
                                </el-dropdown>
                            </div>
                        </el-col>
